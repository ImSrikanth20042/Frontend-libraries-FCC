  ...
  return (
    <div class="Container">
      <div id="quote-box">
        <h1 id="text">
          {quote.quote ||
            "Sorry I didn't save the world my friend, I was busy in building mine again"}
        </h1>
        <h3 id="author">{quote.source || "Kendrick Lamar"}</h3>
        <div className="Btns">
          <button id="new-quote" className="btn-new" onClick={handleNewQuote}>
            New Quote
          </button>
          <button>
            <a
